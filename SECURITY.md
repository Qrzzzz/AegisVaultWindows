...
Security fixes target the default branch, `master`; the current source and latest published stable release are 2.4. Historical releases remain available, but the retired desktop frontend is no longer maintained.
