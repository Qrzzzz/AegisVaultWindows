...
def test_version_constants_for_110() -> None:
...
def test_docs_reference_display_version() -> None:
    for relative in ["README.md", "CHANGELOG.md", "SECURITY.md", "docs/QA_CHECKLIST.md", "docs/releases/v1.1.0.md"]:
...
def test_release_artifact_name_is_standardized() -> None:
    ...
    for relative in ["README.md", "docs/RELEASE_CHECKLIST.md", "docs/releases/v1.1.0.md"]:
