...
def test_version_constants_for_120() -> None:
    assert PACKAGE_VERSION == "1.2.0"
    assert DISPLAY_VERSION == "1.2.0"
    assert RELEASE_TAG == "v1.2.0"
...
def test_docs_reference_display_version() -> None:
    for relative in ["README.md", "CHANGELOG.md", "SECURITY.md", "docs/QA_CHECKLIST.md", "docs/releases/v1.2.0.md"]:
...
def test_release_artifact_name_is_standardized() -> None:
    ...
    for relative in ["README.md", "docs/RELEASE_CHECKLIST.md", "docs/releases/v1.2.0.md"]:
