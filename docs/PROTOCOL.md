...
This document describes the AGV1 formats produced and accepted through AegisVault 2.5. Old AES and AK decryption has been removed; see `docs/MIGRATION.md` for the format-support boundary.
...
New incompatible formats must use a new magic/version combination. AegisVault 2.5 still reads and writes version 1. Legacy formats are neither encrypted nor decrypted.
