...
- WinUI x64 Release publish and packaged backend smoke passed. The executable audit verified 2.9 metadata. Local signing status is `unsigned-optional`; local evidence is separate from public release verification.
...
On 2026-09-13 the maintainer authorized release after these outstanding checks were disclosed. They remain unverified, not passed. Implementation PR #37 and merge `383e5a20c3f22c6cc10d3b3ca8b6f4b1b8a1ef06` passed Quality, Security and Pages. The release workflow independently rebuilds, audits and attests the exact annotated tag before publishing.
